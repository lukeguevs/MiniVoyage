...
//    Étape 2
    ...
    shared_ptr<ReservationElementaire> parisDîner = make_shared<ReservationElementaire>(excursions[0], moment1028);
    journee1028->ajouterReservation(parisDîner);
    shared_ptr<ReservationElementaire> hotelStella2 = make_shared<ReservationElementaire>(hebergements[0], moment1028);
    ...
    shared_ptr<ReservationElementaire> volPortugal = make_shared<ReservationElementaire>(transports[4], moment1029);
    ...
    shared_ptr<ReservationElementaire> hotelRoma2 = make_shared<ReservationElementaire>(hebergements[1], moment1030);
    journee1030->ajouterReservation(hotelRoma2);

    Moment moment1031("2024-10-31");
    shared_ptr<ReservationElementaire> volRetourEasyJet = make_shared<ReservationElementaire>(transports[10], moment1031);
    ...
    shared_ptr<ReservationElementaire> hotelStella3 = make_shared<ReservationElementaire>(hebergements[0], moment1031);
    ...
    shared_ptr<ReservationElementaire> hotelStella4 = make_shared<ReservationElementaire>(hebergements[0], moment1101);
    ...
    shared_ptr<ReservationElementaire> hotelStella5 = make_shared<ReservationElementaire>(hebergements[0], moment1102);
    ...
    shared_ptr<ReservationElementaire> volAirEuropa1025 = make_shared<ReservationElementaire>(transports[12], moment1029);
    journee1029Diego->ajouterReservation(volAirEuropa1025);
    shared_ptr<ReservationElementaire> farHomeAtocha = make_shared<ReservationElementaire>(hebergements[2], moment1029);
    ...
    shared_ptr<ReservationElementaire> excursionTolede = make_shared<ReservationElementaire>(excursions[4], moment1030);
    ...
    shared_ptr<ReservationElementaire> volAirEuropa1026 = make_shared<ReservationElementaire>(transports[13], moment1031);
